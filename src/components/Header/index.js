...
const Header = () => (
    <header>
        <div className="relative">
            ...
            >
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <a href="https://www.businesstoday.com.tw">
                  ...
                  <svg
                    className="fill-current text-primary-dark hover:text-red-500"
                    id="bt_logo"
              ...
              <nav className="hidden text-base text-brown-dark md:flex space-x-10">
                <div className="relative">
                  ...
                  >
                    分類項目
                    <span
                      className="absolute left-0 bottom-0 w-full border-b-2 border-white transform scale-x-0 origin-left transition-all duration-500 group-hover:scale-x-100"
                    ></span>
                  </button>
                </div>
                <div className="relative">
          ...
          <div
            className="hidden absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
          >
            <div
              className="h-screen rounded-md shadow-lg ring-1 ring-black ring-opacity-5 bg-secondary-bg divide-y-2 divide-gray-50"
            >
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    >
                      分類項目
                      <span
                        className="absolute left-0 -bottom-2 w-full border-b-2 border-primary-dark transform scale-x-0 origin-left transition-all duration-500 group-hover:scale-x-100"
                      ></span>
                    </a>
                    <a
                      href="#"
